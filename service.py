...
SERVICE_NAME = "onboarding-relevance-fresh-14"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-15", "FRESH_15_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-16", "FRESH_16_URL"),
)
